...
{
    protected const COLUMN_FUNCTION_TYPE_SEPARATOR = '_';
    protected const COLUMN_COLUMN_SEPARATOR = ',';
        ...
        foreach ($columns as $column) {
            if (!($column instanceof AbstractColumn)) {
                throw new RuntimeException(
                    'The first argument to ScalarFunctionColumn must be an array of AbstractColumns'
                );
            }
            $this->columns[] = $column;
        }
    ...
    public function getId()
    {
        ...
        return $this->scalarFunction->getFunctionName()
            . self::COLUMN_FUNCTION_TYPE_SEPARATOR
            . implode(self::COLUMN_COLUMN_SEPARATOR, $colIds);
    }
