...
class ColumnColumnFilter extends ComparisonFilter
{
    ...
    {
        return array_merge(
            $this->firstColumn->getAllSimpleColumnIds(),
            $this->secondColumn->getAllSimpleColumnIds()
        );
    }
    ...
    {
        return array_merge(
            $this->firstColumn->getScalarFunctionColumns(),
            $this->secondColumn->getScalarFunctionColumns()
        );
    }
    ...
    {
        return array_merge(
            $this->firstColumn->getAllAggregationColumns(),
            $this->secondColumn->getAllAggregationColumns()
        );
    }
    ...
    {
        return
            $this->firstColumn->toQueryString()
            . ' ' . $this->operator . ' '
            . $this->secondColumn->toQueryString();
    }
}
