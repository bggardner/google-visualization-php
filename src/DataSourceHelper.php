...
{
    protected const LOCALE_REQUEST_PARAMETER = 'hl';
    ...
    public static function executeDataSource(DataTableGenerator $dtGenerator, $isRestrictedAccessMode = true)
    {
        try {
            ...
            $newDataTable = DataSourceHelper::applyQuery(
    ...
    public static function verifyAccessApproved(DataSourceRequest $req)
    {
        ...
        if (
            ...
            && $outType != OutputType::TSV_EXCEL
            && $outType != OutputType::HTML
            && !$req->isSameOrigin()
        ) {
            throw new DataSourceException(
                ReasonType::ACCESS_DENIED,
